...
#----------------------------------------------------------
class CoolteveHome(Home):

    @http.route('/web', type='http', auth="none")
    def web_client(self, s_action=None, **kw):
        param_obj = request.env['ir.config_parameter'].sudo()
        request.params['theme_skin_style'] = param_obj.get_param('theme_skin_style') or 'skin-blue'

        return super(CoolteveHome, self).web_client(s_action, **kw)
    ...
    #     requrest.params['theme_skin_style'] = param_obj.get_param('theme_skin_style') or 'skin-blue'
